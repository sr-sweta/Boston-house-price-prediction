...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="UserLogin">
	...
	<asp:Panel ID="PanelLogin" runat="server" BackColor="#fbcbc9"  Height="400px" style="margin-left: 320px;border-radius:50px; margin-right: 320px">
		...
		<asp:TextBox ID="TextBoxEmailId" runat="server" Text="Email Id" style="width: 244px; height: 37px;color:#e75874;text-align:center; position: absolute; left: 550px; top: 825px; z-index: 1; background-color: white;border-width:0px; border-radius:5px;"></asp:TextBox>
        <asp:TextBox ID="TextBoxPassword" runat="server" Text="Password" style="width: 244px; height: 37px; color:#e75874;text-align:center; position: absolute; left: 550px; top: 900px; z-index: 1; background-color: white;border-width:0px; border-radius:5px;"></asp:TextBox>
